...
public class CCJSqlParser implements CCJSqlParserConstants {
  ...
  final public CreateFuzzyDomain CreateFuzzyDomain() throws ParseException {
    ...
    jj_consume_token(89);
       {if (true) return new CreateFuzzyDomain(domain.image, new ExpressionList(list));}
    throw new Error("Missing return statement in function");
  }

//CREATE FUZZY DOMAIN <name> AS VALUES (<label >[,<label>,…,<label>]) [SIMILARITY { (<label>,<label>) / <value> [,(<label>,<label>) / <value>,…, (<label>,<label>) / <value> ] } ]
