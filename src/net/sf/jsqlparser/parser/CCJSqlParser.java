...
public class CCJSqlParser implements CCJSqlParserConstants {
  ...
  final public List GroupByColumnReferences() throws ParseException {
    ...
    columnReference = GroupByColumnReference();
  ...
  final public Expression GroupByColumnReference() throws ParseException {
    Expression columnReference = null;
    Column column = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case K_SIMILAR:
      ...
      column = Column();
                                  {if (true) return new SimilarColumn(column);}
      break;
    case K_NULL:
    case K_CASE:
    case K_REPLACE:
    ...
    case 114:
      columnReference = SimpleExpression();
                                         {if (true) return columnReference;}
      break;
    default:
      jj_la1[70] = jj_gen;
      jj_consume_token(-1);
  ...
  final public OrderByElement OrderByElement() throws ParseException {
        ...
        Column column = null;
        Expression columnReference = null, fuzzyStart = null;
    if (jj_2_10(2)) {
      column = Column();
      jj_consume_token(K_STARTING);
      jj_consume_token(K_FROM);
      fuzzyStart = PrimaryExpression();
        orderByElement.setExpression(column);
        orderByElement.setFuzzyStart(fuzzyStart);
  ...
  final public AlterTable AlterTable() throws ParseException {
    AlterTable alterTable;
    Table table;
    AlterOperation alterOperation;
    ArrayList<AlterOperation> alterOperations = new ArrayList<AlterOperation>();
    jj_consume_token(K_ALTER);
    jj_consume_token(K_TABLE);
    table = Table();
    alterOperation = ChangeColumn();
          alterOperations.add(alterOperation);
    label_32:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 90:
      ...
      alterOperation = ChangeColumn();
        ...
        {if (true) return new AlterTable(table, alterOperations);}
    throw new Error("Missing return statement in function");
  }

  final public ChangeColumn ChangeColumn() throws ParseException {
    String colorg, colnew;
  ...
  final public CreateFuzzyDomain CreateFuzzyDomain() throws ParseException {
    Token domain;
    Expression expression;
    Similarity similarity;
    ArrayList<Expression> expressionList = new ArrayList<Expression>();
    ArrayList<Similarity> similarityList = new ArrayList<Similarity>();

    Column column;
    jj_consume_token(K_CREATE);
    jj_consume_token(K_FUZZY);
    jj_consume_token(K_DOMAIN);
    domain = jj_consume_token(S_IDENTIFIER);
    jj_consume_token(K_AS);
    jj_consume_token(K_VALUES);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 91:
      ...
      default:
        ...
        ;
           ...
           {if (true) return new CreateFuzzyDomain(domain.image,
                                        new ExpressionList(expressionList),
                                        new ExpressionList(similarityList));}
      break;
    case K_FROM:
      jj_consume_token(K_FROM);
      column = Column();
          {if (true) return new CreateFuzzyDomain(domain.image, column);}
      break;
    default:
      jj_la1[155] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Similarity Similarity() throws ParseException {
    Expression label1, label2;
    Token token = null;
    String tmp = "";
    jj_consume_token(91);
    label1 = PrimaryExpression();
    jj_consume_token(90);
    label2 = PrimaryExpression();
    jj_consume_token(92);
    jj_consume_token(108);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 106:
    ...
    default:
      ...
      {if (true) return new Similarity(label1, label2, new DoubleValue(tmp+token.image));}
    throw new Error("Missing return statement in function");
  }

  final public AlterFuzzyDomain AlterFuzzyDomain() throws ParseException {
    Token domain;
    Expression expression;
    Similarity similarity;
    Relation relation;
    ...
    AlterFuzzyDomain alterFuzzyDomain;
    jj_consume_token(K_ALTER);
    jj_consume_token(K_FUZZY);
    jj_consume_token(K_DOMAIN);
    domain = jj_consume_token(S_IDENTIFIER);
      alterFuzzyDomain = new AlterFuzzyDomain(domain.image);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case K_ADD:
      ...
      case K_VALUES:
        ...
        jj_consume_token(92);
             alterFuzzyDomain.setAddValues(new ExpressionList(expressionList));
        break;
      case K_SIMILARITY:
        jj_consume_token(K_SIMILARITY);
        jj_consume_token(115);
        ...
        jj_consume_token(111);
             alterFuzzyDomain.setAddSimilarity(new ExpressionList(similarityList));
        break;
      default:
        jj_la1[161] = jj_gen;
        jj_consume_token(-1);
    ...
    case K_DROP:
      ...
      case K_VALUES:
        ...
        jj_consume_token(92);
             alterFuzzyDomain.setDropValues(new ExpressionList(expressionList));
        break;
      case K_SIMILARITY:
        jj_consume_token(K_SIMILARITY);
        jj_consume_token(115);
        ...
        jj_consume_token(111);
             alterFuzzyDomain.setDropSimilarity(new ExpressionList(relationList));
        break;
      default:
        jj_la1[164] = jj_gen;
        jj_consume_token(-1);
    ...
    default:
      ...
      {if (true) return alterFuzzyDomain;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Relation Relation() throws ParseException {
    ...
    label2 = PrimaryExpression();
    jj_consume_token(92);
      {if (true) return new Relation(label1, label2);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Drop Drop() throws ParseException {
    ...
    case K_INDEX:
      ...
      break;
    case K_FUZZY:
      tk = jj_consume_token(K_FUZZY);
      tk2 = jj_consume_token(K_DOMAIN);
      break;
    default:
      jj_la1[170] = jj_gen;
      jj_consume_token(-1);
      ...
      drop.setType(tk.image + (null != tk2 ? " " + tk2.image : ""));
    tk = jj_consume_token(S_IDENTIFIER);
  ...
  private boolean jj_3_2() {
    ...
    if (jj_scan_token(K_FUZZY)) return true;
    return false;
  }
  ...
  private boolean jj_3R_261() {
    if (jj_scan_token(K_STARTING)) return true;
    if (jj_3R_75()) return true;
    return false;
  }
  ...
  private boolean jj_3R_238() {
    if (jj_scan_token(K_SIMILARITY)) return true;
    if (jj_scan_token(K_ON)) return true;
    if (jj_3R_42()) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x4000000,0x0,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x20000,0x800000,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x800,0x1000,0x1000,0x80000,0x800000,0x0,0x0,0x0,0x0,0x0,0x1000,0x1000,0x0,0x1000,0x1000,0x0,0x0,0x1000,0x1000,0x0,0x1000,0x1000,0x0,0x0,0x0,0x0,0x20,0x0,0x81000000,0x20,0x0,0x0,0x0,0x20,0x18000000,0x10000000,0x10000000,0x0,0x0,0x8000000,0x0,0x800,0x800,0x0,0x81000000,0x0,0x440000,0x440000,0x0,0x81000000,0x0,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x10000,0x10000,0x10000,0x10000,0x81015000,0x10000,0x0,0x0,0x81000000,0x10000,0x81000000,0x10000,0x10000,0x0,0x10000,0x10000,0x0,0x0,0x81005000,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0